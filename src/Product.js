...
function Product({ name, city, price, description, url }) {
  return (
    <div class='relative mx-auto w-full max-w-sm pt-6 pb-3'>
      <a
        href='#'
            ...
            <div class='mt-4 grid grid-cols-2'>
              <div class='flex items-center'>
                <div class='relative'>
                  ...
                  <p
                    class='mt-2 line-clamp-1 text-sm text-gray-800'
              ...
              <div class='flex items-center justify-end'>
                <p class='text-primary inline-block whitespace-nowrap rounded-xl font-semibold leading-tight'>
                  <span class='text-lg'>{price}원</span>
                </p>
              </div>
            </div>

            <div class='mt-2 border-t border-gray-200 pt-3'>{description}</div>
